...
import com.example.bookmytutor.databinding.ActivityMain2Binding
...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMain2.fab2.setOnClickListener { view ->
            Snackbar.make(view, "Any Suggestions", Snackbar.LENGTH_LONG)
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_myaccount2, R.id.nav_myrequests, R.id.nav_logout2
            ), drawerLayout
        )
